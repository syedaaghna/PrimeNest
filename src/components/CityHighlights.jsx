    ...
    <section className="bg-gray-100 py-16 px-4"> 
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }} // Animates when 30% of container is in view, only once
        >
          {cities.map((city) => (
            <motion.div
              key={city.name}
              className="bg-white p-0 rounded-lg shadow-xl overflow-hidden transform transition-transform duration-300 hover:scale-103 cursor-pointer" // Stronger shadow, subtle hover scale, cursor pointer
              variants={itemVariants} // Apply item variants
              whileHover={{ scale: 1.05, boxShadow: "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)" }} // Custom hover effect with shadow
            >
              ...
              <div className="p-6 text-center">
                ...
                <a href={city.link} className="inline-flex items-center text-blue-600 font-medium hover:text-blue-800 transition-colors duration-200">
                  Explore Properties
